...
module.exports = function calculateNewRiskScore (riskScore, range, daysElapsed, mean, stdev, exp, logger) {
  ...
  return calculateGrowthCurve(exp, effectiveDays, riskScore, logger)
